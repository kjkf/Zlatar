...
(function () {
    ...
    function prepareCatalogPhoneForm() {
        ...
        if (catalogPhone) {
            ...
            if (!phone) {
                var modal = document.querySelector('.modal.modal-catalog-phone');
                modal.classList.add('active');
                ...
                closeModal.addEventListener('click', function (e) {
                    var isValid = isFormValid(inputs);
                ...
                inputs.forEach(input => {
                    input.addEventListener('blur', e => {
                        ...
                        if (errorInputs.length === 0) {
                            form.classList.remove('form-err');
                            if(input.type === 'tel') {
                                localStorage.setItem('catalogPhone', input.value);
                            }
...
$(function () {
    ...
    setTimeout(() => {
        ...
        try {
            ...
            maxWidth850.addEventListener("change", function () {
                maxWidth850Handler();
            });
        } catch (e1) {
            try {
                ...
                maxWidth850.addListener(function (e) {
                    maxWidth850Handler();
                });
            } catch (e2) {
                console.error(e2);
...
(function () {
    ...
    setTimeout(() => {
        ...
        //console.log("== +++ create slider", slider);
